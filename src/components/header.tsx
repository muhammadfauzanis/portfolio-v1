          ...
          {links.map((link) => (
            ...
            >
              ...
              >
                <hr
                  className={clsx(
                    'border-[1.5px] group-hover:border-gray-950 dark:border-gray-500 dark:group-hover:border-gray-300 w-10 group-hover:w-20 transition-all duration-500',
                    {
                      ' border-gray-950 dark:border-gray-300 w-20':
                        activeSection === link.hash,
